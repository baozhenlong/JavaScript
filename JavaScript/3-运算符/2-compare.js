...
//1---概述
{
    //比较运算符：比较2个值的大小，然后返回一个布尔值，表示是否满足指定的条件
...
//2---非相等运算符：字符串的比较
{
    ...
    //小写c的Unicode码点(99)大于大写C的Unicode码点(67)
    //所有字符都有Unicode码点，因此汉子也可以比较
    console.log('[非相等运算符]---字符串的比较 ', '大' > '小'); //false
    //"大"的Unicode码点是22823，"小"的Unicode码点是23567，因此返回false
}
